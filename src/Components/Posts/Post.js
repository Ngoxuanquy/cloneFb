...
function Post({ socket }) {
    ...
    const getApiAllPost = () => {
        ...
        fetch(URL + '/getPost', requestOptions)
            .then((data) => data.json())
            .then((data) => {
    ...
    //xét những bạn bè mới lấy apis
    const [apisfriend, setApiFriend] = useState([])
    ...
    // function getCommonElements(array2, array1) {
    //     const commonElements = array1.filter(item => array2.includes(item));
    //     return commonElements;
    // }

    // const result = getCommonElements(friends, apis.map(item => item.user_id));
                ...
                {data?.map((api) => (
                    <div
                        ...
                        <div className='mb-[30px]'>
                            ...
                            <div className='text-[16px] w-[650px] flex flex-row justify-around'>
                                ...
                                {api.comment?.map(ap => (
                                    <div className='flex flex-row mt-[10px] justify-between w-full '>
                                        <div className='flex flex-row '>
                                            ...
                                            <div className='ml-[10px] mt-[-10px] text-[15px]'>
                                                <div>
